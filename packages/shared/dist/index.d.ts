...
export type PersonaCondition = 'depression' | 'anxiety' | 'ptsd' | 'bipolar' | 'ocd' | 'addiction' | 'eating_disorder' | 'crisis';
...
export type WSEventType = 'message' | 'typing_start' | 'typing_stop' | 'user_joined' | 'user_left' | 'session_ended' | 'crisis_detected' | 'score_update';
